    ...
    <el-card class="base-table" ref="fullTable">
            ...
            >
                ...
                <template #operate="{ row }">
                  <el-button link type="primary" icon="Edit" @click="handleUpdate(row)" v-hasPermi="['student:info:edit']">修改</el-button>
                  <el-button link type="primary" icon="Delete" @click="handleDelete(row)" v-hasPermi="['student:info:remove']">删除</el-button>
                </template>
            </auto-table>
...
import { listInfo, getInfo, delInfo, addInfo, updateInfo, importInfo } from "@/api/student/info";
...
function reset() {
  form.value = {
        className: null,        createBy: null,        createTime: null,        dateOfBirth: null,        delFlag: null,        deptId: null,        email: null,        gender: null,        id: null,        major: null,        name: null,        phoneNumber: null,        updateTime: null  };
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除学生信息表编号为"' + _ids + '"的数据项？').then(function() {
    return delInfo(_ids);
  }).then(() => {
    getList();
